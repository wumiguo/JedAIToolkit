...
public class IncComparisonWeightComparator implements Comparator<Comparison> {
   ...
   /* 
    * This comparator orders comparisons in increasing order of weight 
    * (utility measure), i.e., from the smallest weight to the largest one.
...
//        comparisons.add(c3);
//        
//        Collections.sort(comparisons, new IncComparisonWeightComparator());
//        
