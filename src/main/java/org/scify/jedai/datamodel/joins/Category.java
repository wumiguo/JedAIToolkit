...
public class Category {
    ...
    public int sig_len;
    public List<TIntList> subs = new ArrayList<>();
    public HashMap<Integer, TIntList>[] sig_map;

    public Category(int len, double threshold, int categoryN)
    {
        this.THRESHOLD=threshold;
        this.N=categoryN;
        s_len = len;
        e_len = (int) ((double)(s_len / THRESHOLD));
        K = (int) (2 * (1 - THRESHOLD) / (1 + THRESHOLD) * (double)e_len);
        N1 = K + 1;
        N2 = 2;
